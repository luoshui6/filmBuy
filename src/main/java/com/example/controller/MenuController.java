...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
		...
		if (1 == level) {
			...
			array.add(getJsonObject("messageInfo", "交流信息", "layui-icon-table", "messageInfo"));
			...
			array.add(getJsonObject("goodsInfo", "电影详情", "layui-icon-table", "goodsInfo"));
			...
			array.add(getJsonObject("typeInfo", "电影类型", "layui-icon-table", "typeInfo"));
